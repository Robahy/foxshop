...
class FactorMain(QMainWindow):
    ...
    def __setup_ui(self):
        ...
        # Add sid_layout
        right_panel.addItem(top_spacer)
        right_panel.addLayout(input_layout)
        right_panel.addWidget(self.__panel_btn)
        right_panel.addItem(bottom_spacer)
        # Add control_panel
        control_panel.addWidget(self.__table, 8)
        control_panel.addLayout(right_panel, 2)
        # End Control Panel
        # Add Status Panel
        # Add row_count
    ...
    def __signals(self):
        ...
        self.__btn_back_menu1.clicked.connect(lambda: self.__panel_btn.setCurrentIndex(0))
        self.__btn_back_menu2.clicked.connect(lambda: self.__panel_btn.setCurrentIndex(0))
        self.__btn_more_option.clicked.connect(lambda: self.__panel_btn.setCurrentIndex(1))
        self.__btn_supervisor_operations.clicked.connect(lambda: self.__panel_btn.setCurrentIndex(2))
